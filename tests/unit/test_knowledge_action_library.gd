...
func run() -> bool:
	...
	for predicate in [
		...
		"OPENED_BY", "BELONGS_TO", "PRACTICED_WITH", "PRACTICED_BY",
		"SYNERGIZES_WITH", "RECOVERS_AFTER",
		"OPERATED_BY", "OFFERS", "SELLS", "AVAILABLE_AT", "PERFORMED_BY",
		"REQUIRES_MATERIAL", "PRODUCES",
	]:
