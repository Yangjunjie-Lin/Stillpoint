...
class ExplorationandShottingGame:     
    def __init__(self):                
        ...
        self.canvas.bind('<Button-1>', self.shoot)  # Left click to shoot
    ...
    def show_game_instructions(self):
        ...
        instruction_window.geometry("400x500")
        ...
        tk.Label(instruction_window, text=instructions, justify=tk.LEFT).pack(padx=20, pady=20)
        
        tk.Button(instruction_window, text="Got it! Start Game", command=instruction_window.destroy).pack(pady=10)
...
if __name__ == "__main__":
    game = ExplorationandShottingGame()
    game.run()