...
The automated gate currently runs 348 Godot tests with zero unexpected script
errors, errors, ObjectDB leaks, or resource leaks, plus 250 in-memory-applicable
NPC Mind backend tests and 258 tests against PostgreSQL/pgvector. See
