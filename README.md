...
The automated gate currently runs 326 Godot tests with zero unexpected script
errors, errors, ObjectDB leaks, or resource leaks, plus 203 in-memory-applicable
