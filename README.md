...
The automated gate currently runs 317 Godot tests with zero unexpected script
errors, errors, ObjectDB leaks, or resource leaks, plus 200 in-memory-applicable
