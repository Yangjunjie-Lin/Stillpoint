...
def main() -> int:
    ...
    parser.add_argument("--expected-tests", type=int, default=224)
    parser.add_argument("--max-objectdb-leaks", type=int, default=5)
    parser.add_argument("--max-resource-leaks", type=int, default=2)
