...
func _process(delta: float) -> void:
	...
	_visual_root.rotation.y = sin(_idle_time * 0.55) * 0.035
...
func _build_lotus_ascetic() -> void:
	var saffron := Color("d47a31")
	var maroon := Color("743b38")
...
func _build_ronin() -> void:
	var indigo := Color("273d58")
	var charcoal := Color("29292d")
