...
const EQUIPMENT_FOUNDATION: Dictionary = {
	"scout_hood": 1,
	"trail_trousers": 1,
	"road_boots": 1,
	"work_gloves": 1,
...
static func grant_equipment_foundation(inventory: InventoryComponent) -> bool:
	return _grant_items(inventory, EQUIPMENT_FOUNDATION)
