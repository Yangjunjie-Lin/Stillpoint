...
extends Resource
## Immutable authored workplace definition. Mutable payroll is runtime state.
...
@export_range(0, 1000000000, 1) var initial_payroll_funds: int = 0


func is_valid() -> bool:
	return id != &"" and worksite_type != &"" and region_id != &"" and work_marker_id != &"" and capacity > 0
